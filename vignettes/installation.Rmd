...
If you have any problems installing, please check the [Known issues](todo) page to see if there is a known solution. If not then please [raise an issue](https://github.com/mrc-ide/RMAPI/issues) on github.
